...
const HeaderBlock = () => (
  <Block className="col-span-12 row-span-2 md:col-span-6">
    <img
      src="https://api.dicebear.com/8.x/lorelei-neutral/svg?seed=Ryan"
      alt="avatar"
...
const SocialsBlock = () => (
  <>
    ...
    <Block
      ...
      className="col-span-6 bg-yellow-500 md:col-span-3"
    >
      <a
...
const LocationBlock = () => (
  <Block className="col-span-12 flex flex-col items-center gap-4 md:col-span-3">
    ...
    <p className="text-center text-lg text-zinc-400">Greenville, SC</p>
  </Block>
);
